import 'dart:io';
void main() {
  //MIGUEL PEÑA - EJERCICIO WHILE 04
  // El Depto. de Seguridad Publica y Transito del D.F. desea saber, de los n 
  ...
  //DEFINICIÓN
  int cantAutos;
  int  contador = 0, calcAmarilla  =0, calcRosa = 0;
  int calcRoja = 0, calcVerde = 0, calcAzul = 0, placa;

  //PROCESOS
  print("¿Cual es la cantidad de autos que entraron a la ciudad?");
